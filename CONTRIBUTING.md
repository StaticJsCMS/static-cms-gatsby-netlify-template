...
```sh
$ git clone https://github.com/staticjscms/static-cms-gatsby-netlify-template
$ yarn 
```
...
By contributing to the Gatsby - Static CMS starter, you agree that your contributions will be licensed
